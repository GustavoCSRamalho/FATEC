	...
	public void mouseClicked(MouseEvent e){
		...
		for(Tanque t:tanques){
			...
			if (clicado){
				t.setEstaAtivo(true);
				switch(e.getButton()){
					case MouseEvent.BUTTON1: t.girarAntiHorario(3);System.out.println("esquerdo"); break;
					case MouseEvent.BUTTON2: t.aumentarVelocidade();System.out.println("oi"); break;
					case MouseEvent.BUTTON3: t.girarHorario(3);System.out.println("direito"); break;
				}
				break;
			}
		}
